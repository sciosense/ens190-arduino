...
#define ENS190_COMMAND_SET_CO2_BASELINE_MANUALLY_LENGTH     (6)         // Length of "SetCo2Baseline" command
...
#define ENS190_COMMAND_PAYLOAD_SET_CO2_BASELINE_MANUALLY_LENGTH (2)     // Amount of bytes to write for the CO2 baseline
...
#define ENS190_COMMAND_SET_ALARM_THRESHOLDS                 {0x1A, 0x05, 0x13, 0x00, 0x00, 0x00, 0x00, 0xFF}    // Set the alarm threshold
#define ENS190_COMMAND_SET_CO2_BASELINE_MANUALLY            {0x1A, 0x03, 0x18, 0x00, 0x00, 0xFF}                // Set the CO2 baseline
...
#define ENS190_COMMAND_RESPONSE_CO2_VALUE_PAYLOAD               (4)     // Command response length for "ReadCo2" command
#define ENS190_COMMAND_RESPONSE_ABC_PARAMETERS_PAYLOAD          (2)     // Command response length for "SetAbcParameters" command
#define ENS190_COMMAND_RESPONSE_ALARM_THRESHOLDS_PAYLOAD        (4)     // Command response length for "SetAlarmThresholds" command
#define ENS190_COMMAND_RESPONSE_BAUDRATE_PAYLOAD                (1)     // Command response length for "SetBaudRate" command
#define ENS190_COMMAND_RESPONSE_SERIAL_NUMBER_PAYLOAD           (7)    // Command response length for "GetSerialNumber" command
#define ENS190_RESPONSE_PRODUCTION_DATE_PAYLOAD                 (3)     // Command response length for production date part of the "GetSerialNumber"
#define ENS190_RESPONSE_SERIAL_NUMBER_PAYLOAD                   (2)     // Command response length for serial number part of the "GetSerialNumber"
#define ENS190_COMMAND_RESPONSE_FIRMWARE_VERSION_NUMBER_PAYLOAD (11)    // Command response length for "GetFirmwareVesionNumber" command
